...
public class EmailService {
    ...
    public Long sendSignUpMail(String email, String uuid) throws MailException {
        javaMailSender.send(mimeMessage -> {
            ...
            mimeMessageHelper.setText(String.format(ConstUtil.SIGNUP_MAIL_TEXT[1], uuid), true);
        });
        return 200L;
    }
    ...
    public Long sendAuthMail(String email, String uuid) throws MailException {
        javaMailSender.send(mimeMessage -> {
            ...
            mimeMessageHelper.setText(String.format(ConstUtil.AUTH_MAIL_TEXT[1], uuid), true);
        });
        return 200L;
    }
    ...
    public Long sendFindPasswordMail(String email, String uuid) throws MailException {
        javaMailSender.send(mimeMessage -> {
            ...
            mimeMessageHelper.setText(String.format(ConstUtil.FIND_PASSWORD_TEXT[1], uuid), true);
        });
        return 200L;
    }
}
